    ...
    function widget($args, $instance) {
        ...
        if ($portfolios->have_posts()) :
            ...
            <div class="row<?php if ($view == 'small') echo ' gallery-row' ?>">
                <div<?php if ($number > $items) : ?> class="portfolio-carousel owl-carousel show-nav-title" data-cols-lg="1" data-cols-md="3" data-cols-sm="2" data-single="<?php echo $view == 'small' ? '1' : '0' ?>"<?php endif; ?>>
                    <?php
                    $count = 0;
