...
class Porto_Recent_Posts_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if ($posts->have_posts()) :
            ...
            ?>
            <div class="row">
                <div<?php if ($number > $items) : ?> class="post-carousel owl-carousel show-nav-title" data-cols-lg="1" data-cols-md="3" data-cols-sm="2" data-single="<?php echo $view == 'small' ? '1' : '0' ?>"<?php endif; ?>>
                    <?php
                    $count = 0;
